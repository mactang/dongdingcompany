...
@interface NickNameView ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
    BOOL _leftLeave;
}
...
+(NickNameView*)showmessage:(NSString *)message subtitle:(NSString *)subtitle cancelbutton:(NSString *)cancle
{
    NickNameView *alert = [[NickNameView alloc] initWithTitle:message leftButtonTitle:nil rightButtonTitle:cancle];
    [alert show];
    alert.rightBlock = ^() {
   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        UITextField *nickName = [[UITextField alloc]initWithFrame:CGRectMake(0, 70, 300, 40)];
