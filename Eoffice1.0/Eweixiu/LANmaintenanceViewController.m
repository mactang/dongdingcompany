//
//  LANmaintenanceViewController.m
//  Eoffice1.0
//
...
#import "LANTariffViewController.h"
@interface LANmaintenanceViewController ()<UITableViewDelegate,UITableViewDataSource>{
    UITableView *_tableview;
}

@end

@implementation LANmaintenanceViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    [headerView titlelabel:headerarray[section] headerblock:^(UIButton *button) {
        LANTariffViewController *lantariff = [[LANTariffViewController alloc]init];
        [self.navigationController pushViewController:lantariff animated:YES];
    }];
    return headerView;
}
