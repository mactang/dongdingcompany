//
//  ComputerCleaningViewController.m
//  Eoffice1.0
//
...
#import "ComputerTariffViewController.h"
@interface ComputerCleaningViewController ()<UITableViewDataSource,UITableViewDelegate>{
    UITableView *_tableview;
}

@end

@implementation ComputerCleaningViewController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.titleLabel.text = @"电脑清洁保养";
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    [headerView titlelabel:headerarray[section] headerblock:^(UIButton *button) {
        ComputerTariffViewController *computer = [[ComputerTariffViewController alloc]init];
