//
//  HardwareTariffViewController.m
//  Eoffice1.0
//
...
@interface HardwareTariffViewController ()<UITableViewDataSource,UITableViewDelegate,AppointmentDelegate>{
    UITableView *_tableview;
}

@end

@implementation HardwareTariffViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)chooseAddressed{
    ...
    chooseAddress.titlestring = @"硬件检测维修";
