...
@interface OfficeTariffViewController ()<UITableViewDataSource,UITableViewDelegate,AppointmentDelegate>{
    UITableView *_tableview;
}
@end
@implementation OfficeTariffViewController
...
-(void)chooseAddressed{
    ...
    chooseAddress.titlestring = @"办公设备维修";
