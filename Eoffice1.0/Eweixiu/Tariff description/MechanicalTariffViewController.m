//
//  MechanicalTariffViewController.m
//  Eoffice1.0
//
...
@interface MechanicalTariffViewController ()<UITableViewDelegate,UITableViewDataSource,AppointmentDelegate>{
...
@implementation MechanicalTariffViewController
...
-(void)chooseAddressed{
    ...
    chooseAddress.titlestring = @"机电维修";
