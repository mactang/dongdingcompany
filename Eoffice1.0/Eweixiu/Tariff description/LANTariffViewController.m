...
@interface LANTariffViewController ()<UITableViewDataSource,UITableViewDelegate,AppointmentDelegate>{
    UITableView *_tableview;
}
@end

@implementation LANTariffViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)chooseAddressed{
    ...
    chooseAddress.titlestring = @"局域网维修";
