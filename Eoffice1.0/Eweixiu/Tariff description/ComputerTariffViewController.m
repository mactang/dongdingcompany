//
//  ComputerTariffViewController.m
//  Eoffice1.0
//
...
@interface ComputerTariffViewController ()<UITableViewDataSource,UITableViewDelegate,AppointmentDelegate>{
    
    UITableView *_tableview;
    
}
@end
@implementation ComputerTariffViewController
...
-(void)chooseAddressed{
    ...
    chooseAddress.titlestring = @"电脑清洁保养";
