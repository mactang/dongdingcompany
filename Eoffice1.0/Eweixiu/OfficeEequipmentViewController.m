//
//  OfficeEequipmentViewController.m
//  Eoffice1.0
//
...
#import "OfficeTariffViewController.h"
@interface OfficeEequipmentViewController ()<UITableViewDataSource,UITableViewDelegate>{
    UITableView *_tableview;
}
@end
@implementation OfficeEequipmentViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.titleLabel.text = @"办公设备维修";
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    [headerView titlelabel:headerarray[section] headerblock:^(UIButton *button) {
        OfficeTariffViewController *officeTariff = [[OfficeTariffViewController alloc]init];
        [self.navigationController pushViewController:officeTariff animated:YES];
    }];
    return headerView;
}
