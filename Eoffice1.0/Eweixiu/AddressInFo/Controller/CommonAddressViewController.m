...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *CellIdentifier = @"CommonAddressTableViewCell";
    CommonAddressTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    
    if(cell == nil){
        cell = LOAD_NIB(@"CommonAddressTableViewCell");
    }
    return cell;
}
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CommonAddressTableViewCell *oneCell = [tableView cellForRowAtIndexPath: indexPath];
