...
@interface SixAlterView ()<UITableViewDelegate,UITableViewDataSource>
{
    BOOL _leftLeave;
}
...
{
    SixAlterView *alert = [[SixAlterView alloc] initWithTitle:message leftButtonTitle:nil rightButtonTitle:cancle];
    [alert show];
    alert.rightBlock = ^() {
