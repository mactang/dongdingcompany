...
- (void)downData{
    ...
    NSString *path= [NSString stringWithFormat:SERVICEREASON,model.jsessionid,model.userkey];
    NSLog(@"%@",path);
...
-(void)serviceDatas{
    ...
    NSString *path= [NSString stringWithFormat:SERVICESUBMIT,model.jsessionid,model.userkey,model.serviceOrderId];
    NSLog(@"%@",path);
