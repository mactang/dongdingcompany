...
#define APP_ID          @"wxd20a08d7a7efd6b4"               //APPID
#define APP_SECRET      @"7ac03523b9ee4296d2adf49648702c62" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1280883501"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"1cllqySNg4cvznY07hl7vYdWVbb5HIoL"
//支付结果回调页面
