...
@interface GYZAlterview ()<UITableViewDelegate,UITableViewDataSource>
{
    BOOL _leftLeave;
}
...
{
    GYZAlterview *alert = [[GYZAlterview alloc] initWithTitle:message leftButtonTitle:nil rightButtonTitle:cancle];
    [alert show];
    alert.rightBlock = ^() {
